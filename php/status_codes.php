...
foreach ($websites as $website) {
    $q = new stdClass();
    $q->size = "0";
    $q->aggs->{2}->terms->field = "http.response.status_code";
    ...
    $q->query->bool->filter[]->match_phrase->{"http.request.referrer"}->query = "$website";
    ...
    $request = $client->get("/filebeat-*/_search", ["body" => $json]);
